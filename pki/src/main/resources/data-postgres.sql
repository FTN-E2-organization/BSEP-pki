...
INSERT INTO users (id, username, password,authority_id, enabled, salt) VALUES (nextval('users_seq'),'isa.user.test@gmail.com','$2y$12$esSysQuIMJjPmQAxDLNtfuGrTuVn1xBO1ieY.tqMSo46SdUQyMUxC',2, false, '1234567k');
...
INSERT INTO users (id, username, password,authority_id, enabled, salt) VALUES (nextval('users_seq'),'admin@mail.com','$2y$12$esSysQuIMJjPmQAxDLNtfuGrTuVn1xBO1ieY.tqMSo46SdUQyMUxC',1, true, '1234567k');
INSERT INTO users (id, username, password,authority_id, enabled, salt) VALUES (nextval('users_seq'),'ftn@uns.ac.rs','$2y$12$esSysQuIMJjPmQAxDLNtfuGrTuVn1xBO1ieY.tqMSo46SdUQyMUxC',2, true, '1234567k');
INSERT INTO users (id, username, password,authority_id, enabled, salt) VALUES (nextval('users_seq'),'marija.maric98@gmail.com','$2y$12$esSysQuIMJjPmQAxDLNtfuGrTuVn1xBO1ieY.tqMSo46SdUQyMUxC',2, true, '1234567k');
INSERT INTO users (id, username, password,authority_id, enabled, salt) VALUES (nextval('users_seq'),'pmf@uns.ac.rs','$2y$12$esSysQuIMJjPmQAxDLNtfuGrTuVn1xBO1ieY.tqMSo46SdUQyMUxC',2, true, '1234567k');
INSERT INTO users (id, username, password,authority_id, enabled, salt) VALUES (nextval('users_seq'),'pera_peric99@gmail.com','$2y$12$esSysQuIMJjPmQAxDLNtfuGrTuVn1xBO1ieY.tqMSo46SdUQyMUxC',2, true, '1234567k');
INSERT INTO users (id, username, password,authority_id, enabled, salt) VALUES (nextval('users_seq'),'etf.bg@gmail.com','$2y$12$esSysQuIMJjPmQAxDLNtfuGrTuVn1xBO1ieY.tqMSo46SdUQyMUxC',2, true, '1234567k');
INSERT INTO users (id, username, password,authority_id, enabled, salt) VALUES (nextval('users_seq'),'nada_nadic@gmail.com','$2y$12$esSysQuIMJjPmQAxDLNtfuGrTuVn1xBO1ieY.tqMSo46SdUQyMUxC',2, true, '1234567k');
